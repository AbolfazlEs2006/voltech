      ...
      <footer className="bg-gray-200 text-gray-800 dark:bg-gray-800 dark:text-gray-200 text-end p-5 flex flex-col lg:flex-row lg:flex-row-reverse">
        <section className=" w-full">
          ...
          <div className="grid grid-cols-2 justify-between items-center">
            ...
            <Link href={"/basket"} className="mb-3">
              سبد خرید
            </Link>
            <Link href={"/profile"}>پروفایل</Link>
            <Link href={"/products"} className="mb-3">
              فروشگاه
            </Link>
        ...
        <section className="mt-6 w-full lg:ml-10">
          ...
          <p className="mb-5">
            ...
            و برقی، به عنوان یکی از بزرگترین تولیدکنندگان ابزارآلات در ایران و
            شناخته می‌شود. ما در سریوان، با تعهد به ارائه محصولات باکیفیت،
            بادوام همواره در تلاشیم تا نیازهای متنوع مشتریان خود در سراسر کشور
            را برآورده سازیم.گروه صنعتی سریوان با سابقه‌ای درخشان در تولید و
            عرضه ابزارآلات دستی و برقی، به عنوان یکی از بزرگترین تولیدکنندگان
            ابزارآلات در ایران و شناخته می‌شود.گروه صنعتی سریوان با سابقه‌ای
            درخشان در تولید و عرضه ابزارآلات دستی و برقی، به عنوان یکی از
        ...
        <section className=" w-full">
          ...
          <div className="mt-2">
            <h1 className="flex justify-between flex-row-reverse mb-3">
              ...
              <span>ایران تهران تهران پلاک 1</span>
            </h1>
            <h1 className="flex justify-between flex-row-reverse mb-3">
